...
<div class="AspNet-Login">
			...
			<br>
				    ...
				    <div id="Figure">
				        <a id="ctl00_cphRoblox_LoginView1_ImageFigure" disabled="disabled" title="Figure" onclick="return false" style="display:inline-block;"><img style="width:115px;height:130px;" src="<?php // /images/NewFrontPageGuy.png ?>/img/user/1.png" border="0" alt="Figure" blankurl="http://t1.roblox.com:80/blank-115x130.gif"></a>
				    </div>
...
<img onclick='window.open("https://www.youtube.com/shorts/UHm7NJCyC48?feature=share", "_blank");' style="cursor: pointer;position: absolute;right: 19px;width: 304px;" src="https://datepsychology.com/wp-content/uploads/2022/09/gigachad.jpg">
	...
	<div id="Showcase" style="margin-right: 10px;">
        <iframe id="embedplayer" src="https://www.youtube.com/embed/0pCofClXlfc" width="400" height="326" allowfullscreen="" scrolling="off" frameborder="0" data-ruffle-polyfilled=""></iframe>
        <br><br>
      </div>
	<div id="Install">
