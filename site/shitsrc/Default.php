...
<div class="AspNet-Login">
						<form method="post" action="/Login/Default.aspx"><div class="AspNet-Login">
							...
							<div class="AspNet-Login-SubmitPanel">
								<a id="ctl00_cphRoblox_rbxLoginView_lvLoginView_lSignIn_Login" tabindex="4" type="submit" class="Button">Login</a>
							</div>
...
</div><?php } if($loggedin == true){ ?>
<div id="LoginViewContainer">
			<div id="LoginView">
								<h5>Logged in</h5>
				<div id="AlreadySignedIn">
					<a title="You" href="/User.aspx" style="display:inline-block;height:190px;width:152px;cursor:pointer;"><img src="http://goodblox.xyz/goodblox/images/render/avatar/6403.png" style="display:inline-block;height:185px;width:145px;margin-top:15px;" border="0" id="img" alt="6403"></a>
				</div>
							</div>
		</div>
<?php } ?>
...
<div id="RobloxAtAGlance">
	...
	<div id="Showcase" style="margin-right: 10px;">
        <iframe id="embedplayer" src="https://www.youtube.com/embed/MrMKL2fezYU?si=W10oLMEgtUTSoVVX" width="400" height="326" allowfullscreen="" scrolling="off" frameborder="0" data-ruffle-polyfilled=""></iframe>
        <br><br></div>
	<div id="Install">
	...
	<div id="ForParents">
		<a id="ctl00_cphRoblox_RobloxAtAGlanceLoginView_RobloxAtAGlance_Anonymous_hlKidSafe" title="ROBLOX is kid-safe!" href="Parents.aspx" style="display:inline-block;"><img title="ROBLOX is kid-safe!" src="/images/COPPASeal-150x150.png" border="0"></a>
	</div>
</div>
