...
if(isset($_GET["ogid"])) {
	header('location: /Forum/reply.aspx?id='.(int)$_GET["ogid"].'&replyid='.$_GET["id"]);
	exit;
}

$fq = $db->prepare("SELECT * FROM forum WHERE id=:id");
$fq->bindParam(':id', $id);
$fq->execute();
...
$fr = $db->prepare("SELECT * FROM forum WHERE reply_to=:id");
$fr->bindParam(':id', $id);
$fr->execute();
$fauthor = $db->prepare("SELECT * FROM users WHERE id=:author_id");
...
$fauthorpostcount = $db->prepare("SELECT * FROM forum WHERE author=:author_id");
...
if ($loggedin == "yes") {
  if (isset($_POST['content'])) {
    ...
    $rn = time();
   $stmt = $db->prepare("INSERT INTO `forum` (`author`, `reply_to`, `title`, `content`, `time_posted`, `category`)
...
$stmt->execute();
	  header('location: /Forum/ShowPost.php?id='.$id);
	  exit;
	}}
  }
...
$stmt = $db->prepare("SELECT COUNT(*) FROM forum WHERE author=:author");
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td valign="top" align="left">
                                      <a id="ReplyPostedBy" class="normalTextSmall" href=""><?php echo htmlspecialchars($fauthor['username']) ?></a>
                                  ...
                                  <tr>
                                    ...
                                    <td valign="top" align="left"><a id="ReplySubject" class="normalTextSmall" href="Topic.php?id=102"><?php echo filterText(htmlspecialchars($fpost['title'])) ?></a></td>
                                  </tr>
                                  <tr>
                                    <td valign="top" align="right"><span class="normalTextSmallBold">Message: </span></td>
                                    <td valign="top" align="left"><span class="normalTextSmall"><label id="ReplyBody"><?php echo filterText(htmlspecialchars($fpost['content'])) ?></label>
                                      </span>
                                    </td>
                                  </tr>
                                </tbody>
                              ...
                              <table cellspacing="1" cellpadding="3">
                                <tbody>
                                  <tr>
                                    ...
                                    <td valign="top" align="left" colspan="2"><span class="normalTextSmall"><span id="PostAuthor"><?php echo htmlspecialchars($_USER['username']) ?></span>
                                      </span>
                                    </td>
                                  </tr>
                                                                    <tr>
                                  ...
                                  <tr>
                                    <td valign="top" align="right" colspan="2">
                                      <a onclick="history.back(-1);"><input type="submit" name="Cancel" id="Cancel" value=" Cancel "></a>
                                    </td>
                                  </tr>
                                  <tr>
